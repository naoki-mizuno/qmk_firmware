    ...
    switch (keycode) {
        ...
        case KC_VBAT:
            if (record->event.pressed) {
                uint32_t level = bluefruit_le_read_battery_voltage();
                send_string(get_u8_str(level, ' '));
                //char    vbat[8];
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* BASE Level: Default Layer
     ...
     |-------+---+---+---+---+---+---+---+---+---+---+-------+-----+-------+---|
     | Shift | ; | Q | J | K | X | B | M | W | V | Z | Shift | Fn1 |       |   |
     |-------+---+---+---+---+---+---+---+---+---+---+-------+-----+-------+---|
    ...
    */
    ...
    /* Layer HHKB: HHKB mode (HHKB Fn)
      ...
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      |      | VoD | VoU | Mut |    |    | *  | /  | Hom | PgU | Lef | Rig | Enter | VBATT |     |
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      |      |     |     |     |    |    | +  | -  | End | PgD | Dow |     |       |       |     |
      |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
    ...
    /* Layer Mouse: Mouse mode
      ...
      |------+------+------+------+------+------+------+------+------+------+------+------+-----+---+-----|
      |      | BTN1 |  UP  | BTN2 |      | REC1 | REC2 |      |      |      |      |  Up  |     |   |     |
      |------+------+------+------+------+------+------+------+------+------+------+------+-----+---+-----|
      |      | LEFT | DOWN | RGHT | WH_U | PLY1 | PLY2 |      |      |      | Left | Rght |     |   |     |
      |------+------+------+------+------+------+------+------+------+------+------+------+-----+---+-----|
      |      | WH_L | BTN3 | WH_R | WH_D | RSTP |      |      |      |      | Down |      |     |   |     |
      |------+------+------+------+------+------+------+------+------+------+------+------+-----+---+-----|
